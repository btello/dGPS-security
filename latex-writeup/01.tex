...
based on this correction data.  Our attack successfully convinces the
client that it is located at the given offset from its current location
that we specified.  Figure three shows how a client is affected by the
